...
const cardData = [
  ...
  // HỘP 3: Mobile Developer
  {
    color: "#060010",
    title: "Mobile Apps",
    description:
      "Developing smooth, high-performance iOS & Android apps with React Native.",
      ...
      <style>
        {`
          ...
          @media (min-width: 1024px) {
            ...
            .card-responsive .card:nth-child(4) { grid-area: area4; }
          }
          ...
          @media (max-width: 599px) {
            .card-responsive .card { width: 100%; min-height: 240px; }
          }
        `}
      </style>
                ...
                {card.icon && (
                  <div className={getLottieClass(card.layout)}>
                    <Lottie
                      ...
                      autoplay={true}
                      style={{
                        width: card.layout === "center" ? "80%" : "100%",
                        height: card.layout === "center" ? "80%" : "100%",
                      }}
                    />
                  </div>
                )}
